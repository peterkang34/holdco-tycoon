  ...
  return (
    <>
      ...
      <DataTable
        ...
        rows={[
          ['1', 'Deal Sourcing Team', '$800K', '$350K/yr', '2+', '+2 sourced deals in focus sector, Source Deals costs $300K (was $500K), sourced deals last 3 rounds (was 2), acquisition capacity: 3/year'],
  ...
  return (
    <>
      ...
      <HighlightBox variant="tip">
        ...
        Credit &amp; Lending unlocks after earning at least 16 achievements (any combination).
  ...
  return (
    <>
      ...
      <BulletList items={[
        ...
        <><strong>Pro Sports Franchises:</strong> exclusive FO sector featuring 200 real teams across 8 leagues (NFL, NBA, MLB, NHL, EPL, MLS, WNBA, NWSL). Trophy assets with high multiples (10-25x) and low margins (5-18%). You can own one team per league. Pro sports teams cannot be merged, tuck-in, or designated as platforms — they operate as standalone trophy assets. Women&rsquo;s leagues (WNBA, NWSL) offer more flexible deal structures including seller notes and earn-outs. Owning a franchise guarantees a bonus sports event every year (championship runs, draft picks, scandals, media deals)</>,
