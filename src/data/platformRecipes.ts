...
export const PLATFORM_RECIPES: PlatformRecipe[] = [
  ...
  // ── Media & Entertainment ──
  {
    ...
    requiredSubTypes: ['Digital Media / Publishing', 'Podcast / Audio Network', 'Gaming / Interactive'],
    minSubTypes: 2,
    baseEbitdaThreshold: 5000,
    bonuses: { marginBoost: 0.04, growthBoost: 0.04, multipleExpansion: 1.5, recessionResistanceReduction: 0.8 },
    integrationCostFraction: 0.20,
    description: 'Cross-platform digital content empire: written, audio, and interactive.',
    realWorldExample: 'Spotify + Gimlet, Vox Media',
  },
  {
    id: 'media_live_production',
    name: 'Live & Production Platform',
    sectorId: 'mediaEntertainment',
    requiredSubTypes: ['Live Events & Venues', 'Film & TV Post-Production', 'Talent Management / Agency'],
    minSubTypes: 2,
    baseEbitdaThreshold: 6000,
    bonuses: { marginBoost: 0.03, growthBoost: 0.02, multipleExpansion: 1.5, recessionResistanceReduction: 0.85 },
    integrationCostFraction: 0.22,
    description: 'Vertically integrated talent, production, and venue operations.',
    realWorldExample: 'Endeavor (WME + UFC + IMG), AEG',
  },
  ...
  // ── Fintech & Payments ──
  {
    ...
    sectorId: 'fintech',
    requiredSubTypes: ['Payment Processing / ISO', 'B2B Payments / AP Automation', 'Embedded Finance / BaaS'],
    minSubTypes: 2,
    baseEbitdaThreshold: 7000,
    bonuses: { marginBoost: 0.05, growthBoost: 0.04, multipleExpansion: 2.0, recessionResistanceReduction: 0.75 },
    integrationCostFraction: 0.25,
    description: 'End-to-end payment infrastructure: processing, B2B automation, and embedded finance.',
    realWorldExample: 'Stripe, Adyen, Nuvei',
  },
  {
    id: 'fintech_capital_markets',
    name: 'Capital Markets Fintech Platform',
    sectorId: 'fintech',
    requiredSubTypes: ['Compliance / RegTech', 'Lending Platform / Marketplace', 'Wealth / Investment Tech'],
    minSubTypes: 2,
    baseEbitdaThreshold: 7000,
    bonuses: { marginBoost: 0.04, growthBoost: 0.03, multipleExpansion: 1.5, recessionResistanceReduction: 0.8 },
    integrationCostFraction: 0.22,
    description: 'Integrated lending, investment, and compliance technology platform.',
    realWorldExample: 'Broadridge, SS&C Technologies',
  },
  ...
  // ── Aerospace & Defense ──
  {
    ...
    sectorId: 'aerospace',
    requiredSubTypes: ['MRO / Aftermarket Parts', 'Avionics & Electronics', 'Aerostructures / Composites'],
    minSubTypes: 2,
    baseEbitdaThreshold: 8000,
    bonuses: { marginBoost: 0.04, growthBoost: 0.02, multipleExpansion: 2.0, recessionResistanceReduction: 0.75 },
    integrationCostFraction: 0.25,
    description: 'Vertically integrated MRO with proprietary avionics and structural repair capabilities.',
  ...
  },
  {
    ...
    sectorId: 'aerospace',
    requiredSubTypes: ['Defense Subsystems / Components', 'Simulation & Training Systems', 'Space & Satellite Services'],
    minSubTypes: 2,
    baseEbitdaThreshold: 8000,
  ...
  },
  {
    ...
    requiredSubTypes: ['Digital Media / Publishing', 'Podcast / Audio Network', 'Digital/Ecommerce Agency', 'Performance Media Agency'],
    minSubTypes: 2,
    baseEbitdaThreshold: 8000,
    bonuses: { marginBoost: 0.04, growthBoost: 0.03, multipleExpansion: 1.5, recessionResistanceReduction: 0.8 },
    integrationCostFraction: 0.22,
  ...
  },
  {
    ...
    requiredSubTypes: ['Lending Platform / Marketplace', 'Embedded Finance / BaaS', 'Direct Lending / Senior Debt', 'Revenue-Based Finance'],
    minSubTypes: 2,
    baseEbitdaThreshold: 10000,
    bonuses: { marginBoost: 0.05, growthBoost: 0.04, multipleExpansion: 2.0, recessionResistanceReduction: 0.75 },
    integrationCostFraction: 0.25,
  ...
  },
  {
    ...
    requiredSubTypes: ['MRO / Aftermarket Parts', 'Defense Subsystems / Components', 'Precision Parts / Components', 'Engineered Products'],
    minSubTypes: 2,
    baseEbitdaThreshold: 10000,
    bonuses: { marginBoost: 0.04, growthBoost: 0.02, multipleExpansion: 2.0, recessionResistanceReduction: 0.75 },
    integrationCostFraction: 0.25,
