...
export const SECTOR_EVENTS: SectorEventDefinition[] = [
  ...
  // Private Credit & Lending events
  {
    type: 'sector_event',
    sectorId: 'privateCredit',
    title: 'Credit Cycle Contraction',
    description: 'Rising defaults force increased loan loss reserves. Credit quality deteriorates across your lending portfolio.',
    probability: 0.04,
    effectDescription: '-8% revenue for all lending businesses (credit losses)',
    ebitdaEffect: -0.08,
    affectsAll: true,
    tip: 'Credit cycles are inevitable. The best lenders build reserves during good times and buy distressed assets during bad times.',
  },
  {
    type: 'sector_event',
    sectorId: 'privateCredit',
    title: 'Regulatory Overhaul',
    description: 'New compliance requirements increase operational costs but create barriers to entry for smaller competitors.',
    probability: 0.03,
    effectDescription: '-5% revenue for all lending businesses, +2% growth (competitors exit)',
    ebitdaEffect: -0.05,
    growthEffect: 0.02,
    affectsAll: true,
    tip: 'Regulation is a moat for scaled lenders. Compliance costs are fixed — larger platforms absorb them more easily.',
  },
  {
    type: 'sector_event',
    sectorId: 'privateCredit',
    title: 'Bank Retreat from Middle Market',
    description: 'Regional banks pull back from middle-market lending, driving borrowers to private credit. Origination volume surges.',
    probability: 0.03,
    effectDescription: '+10% revenue, +3% growth for one lending business',
    ebitdaEffect: 0.10,
    growthEffect: 0.03,
    affectsAll: false,
    tip: 'Every time banks retreat, private credit advances. The structural shift from bank lending to private credit is the defining trend in middle-market finance.',
  },
  {
    type: 'sector_event',
    sectorId: 'privateCredit',
    title: 'Spread Compression',
    description: 'Intense competition from new entrants compresses net interest margins across the lending sector.',
    probability: 0.04,
    effectDescription: '-6% revenue for all lending businesses (margin compression)',
    ebitdaEffect: -0.06,
    affectsAll: true,
    tip: 'When every PE firm launches a credit arm, spreads compress. Differentiate through origination quality and borrower relationships.',
  },
  {
    type: 'sector_event',
    sectorId: 'privateCredit',
    title: 'Distressed Debt Opportunity',
    description: 'Market dislocation creates a wave of high-yield distressed lending opportunities with attractive risk-adjusted returns.',
    probability: 0.03,
    effectDescription: '+12% revenue for one lending business (distressed yields)',
    ebitdaEffect: 0.12,
    affectsAll: false,
    tip: 'The best returns in credit come from lending when others can\'t or won\'t. Distressed lending is where disciplined capital allocators earn outsized returns.',
  },
