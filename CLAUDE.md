...
- **Tests**: Vitest in `src/engine/__tests__/` — 867 tests across 16 suites (incl. display-proofreader)
...
- `src/engine/__tests__/display-proofreader.test.ts` — 183 tests: UI copy vs engine constants (MUST update when changing mechanics or UI copy)
...
- **`display-proofreader.test.ts`** — 183 tests that validate UI copy matches engine constants
