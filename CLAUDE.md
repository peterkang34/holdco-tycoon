...
- `src/engine/__tests__/display-proofreader.test.ts` — 108 tests: UI copy vs engine constants (MUST update when changing mechanics or UI copy)
...
- **`display-proofreader.test.ts`** — 108 tests that validate UI copy matches engine constants
