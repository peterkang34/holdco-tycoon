...
- **Tests**: Vitest in `src/engine/__tests__/` — 1427 tests across 25 suites (incl. display-proofreader + playtest system); API integration tests in `api/__tests__/` — 40 tests across 5 suites (stats, history, claim-history, export, delete)
