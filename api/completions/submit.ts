  ...
  try {
    ...
    if (body.isBusinessSchool === true) {
      const bsRecord = {
        ...
        founderEquityValue: typeof body.founderEquityValue === 'number' ? Math.min(Math.round(body.founderEquityValue), 10_000_000_000) : 0,
    ...
    const record = {
      ...
      enterpriseValue: typeof body.enterpriseValue === 'number' ? Math.min(Math.round(body.enterpriseValue), 20_000_000_000) : 0,
      founderEquityValue: typeof body.founderEquityValue === 'number' ? Math.min(Math.round(body.founderEquityValue), 10_000_000_000) : 0,
      score,
      grade,
