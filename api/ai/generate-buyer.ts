...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    const prompt = `You are writing for a private equity acquisition game. Rewrite this investment thesis to be more specific and compelling.
...
Write 2-3 sentences that sound like a real PE investment committee memo. Be specific about value creation levers. Respond with ONLY the thesis text, no JSON or formatting.`;
